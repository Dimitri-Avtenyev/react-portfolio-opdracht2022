        ...
        <div style={switchTheme(theme)} className={styles.ContactContainer}>
            <div className={styles.form}>
                ...
                <Form id="formContact" className={styles.form} onSubmit={handleSubmit}>
                    <FloatingLabel className={styles.input} controlId="floatingInput" label="Email address">
                        <Form.Control type="email" placeholder="name@example.com"  name="email"
                        onChange={(e) => {setEmail(e.target.value)}} value={email}
                        />
                    </FloatingLabel>
                    <FloatingLabel className={styles.input}  controlId="floatingInput" label="Name">
                        <Form.Control type="text" placeholder="Name" name="name"
                        onChange={(e) => {setName(e.target.value)}} value={name}
                        />
                    </FloatingLabel>
                    <FloatingLabel className={styles.input} controlId="floatingTextArea" label="Leave a message!">
